import{E as h,c as p,J as n,p as l,a as i,a6 as e,m as s,o as k}from"./chunks/framework.c2jmegWL.js";const t={viewImg:{"App.vue":`
 <template>
 ...
 self.onmessage = (e) => {
    ...
    self.postMessage(result);
       ...
       `}},r=e(`<h4 id="vite-对图片的识别和处理" tabindex="-1">vite 对图片的识别和处理 <a class="header-anchor" href="#vite-对图片的识别和处理" aria-label="Permalink to &quot;vite 对图片的识别和处理&quot;">​</a></h4><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">路径必须是静态的！（使用动态的不生效例如v</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">bind绑定）</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">img</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> :src=&quot;item.imgType</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> ===</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;热式&#39;</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> ?</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;./samall.svg&#39;</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> :</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> \`./big.svg\`&quot;&gt;</span></span></code></pre></div><h4 id="vite-图片生产和打包名称一致" tabindex="-1">vite 图片生产和打包名称一致 <a class="header-anchor" href="#vite-图片生产和打包名称一致" aria-label="Permalink to &quot;vite 图片生产和打包名称一致&quot;">​</a></h4><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 通过import导入</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">（释放）URL占用的资源    </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">URL</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.revokeObjectURL</span></span></code></pre></div>`,6),E=s("h4",{id:"selct全选all的循环",tabindex:"-1"},[i("selct全选all的循环 "),s("a",{class:"header-anchor",href:"#selct全选all的循环","aria-label":'Permalink to "selct全选all的循环"'},"​")],-1),d=s("ol",null,[s("li",null,"采用循环（推荐）")],-1),g=s("h4",{id:"多线程-new-worker",tabindex:"-1"},[i("多线程(new Worker) "),s("a",{class:"header-anchor",href:"#多线程-new-worker","aria-label":'Permalink to "多线程(new Worker)"'},"​")],-1),c=e(`<h4 id="后台管理项目的屏幕适配" tabindex="-1">后台管理项目的屏幕适配 <a class="header-anchor" href="#后台管理项目的屏幕适配" aria-label="Permalink to &quot;后台管理项目的屏幕适配&quot;">​</a></h4><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 采用缩放</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">   项目中采用第三方库：发现popper组件，下拉框的组件存在错位，不缩放的情况</span></span></code></pre></div><h4 id="_100ms轮询数据构建趋势图" tabindex="-1">100ms轮询数据构建趋势图 <a class="header-anchor" href="#_100ms轮询数据构建趋势图" aria-label="Permalink to &quot;100ms轮询数据构建趋势图&quot;">​</a></h4><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 为了让数组不再增加</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    内部采用this.</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&amp;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ref.tree.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">setChecked</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">()去实现字选项的勾选，这样就减少了卡顿</span></span></code></pre></div>`,6),f=JSON.parse('{"title":"","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"realProject/realProject.md","filePath":"realProject/realProject.md","lastUpdated":null}'),y={name:"realProject/realProject.md"},D=Object.assign(y,{setup(o){return(u,F)=>{const a=h("Playground");return k(),p("div",null,[r,n(a,{files:l(t).viewImg},null,8,["files"]),i(),E,d,n(a,{files:l(t).arrayLoop},null,8,["files"]),g,n(a,{files:l(t).multithreading},null,8,["files"]),i(),c])}}});export{f as __pageData,D as default};
